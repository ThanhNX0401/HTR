...
if __name__ == "__main__":
    ...
    # save_pth= torch.load('/content/EasyOCR/trainer/craft/exp/custom_data_train/CRAFT_clr_amp_30.pth')
    # model = save_pth["craft"] 
    # torch.save(model , "detector.pth")
    ...
    reader.detector = reader.initDetector("detector.pth")

    img = cv2.imread("/content/combined_001_009.jpg")
    bbox = reader.readtext(img)
